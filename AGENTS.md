...
- Mantenere il sito statico, semplice e pubblicabile con GitHub Pages.
- Non aggiungere analytics, cookie di profilazione, banner cookie o strumenti di tracciamento senza richiesta esplicita.
- Non aggiungere database, backend, CMS o framework client-side pesanti.
- Non aggiungere dipendenze non necessarie.
- Mantenere accessibilità, buon contrasto, navigazione chiara e focus visibile da tastiera.
